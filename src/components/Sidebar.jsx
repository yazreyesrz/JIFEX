    ...
    <>
      ...
      >
        <button
          ...
          className="flex items-center gap-2 outline-none focus:outline-none focus:ring-0 shrink-0"
        >
          <span
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-slate-400 hover:text-amber-500 focus:outline-none p-1 rounded-lg transition-colors active:scale-95"
          >
      ...
      >
        ...
        >
          <button
            ...
            className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl border text-xs font-bold uppercase tracking-wider transition duration-200 cursor-pointer outline-none active:scale-[0.97] ${isDarkMode ? "bg-[#1e293b]/30 border-slate-800 text-amber-400 hover:bg-[#1e293b]/60" : "bg-slate-50 border-slate-200 text-amber-600 hover:bg-slate-100"}`}
          >
