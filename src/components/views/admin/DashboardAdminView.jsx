  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      >
        ...
        <div
          className={`px-4 py-2 rounded-xl border text-xs font-bold flex items-center gap-2 ${isDarkMode ? "bg-[#1e293b]/50 border-slate-700 text-slate-300" : "bg-white border-slate-200 text-slate-600"}`}
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, idx) => (
          <div
            key={idx}
            className={`rounded-3xl border p-6 transition-transform hover:-translate-y-1 ${isDarkMode ? "bg-[#1e293b]/40 border-slate-800/60" : "bg-white border-slate-200 shadow-xl shadow-slate-200/50"}`}
          >
            ...
            <div>
              <h3
                className={`text-2xl font-black tracking-tight ${isDarkMode ? "text-white" : "text-slate-800"}`}
              >
                {stat.value}
              </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div
          className={`lg:col-span-2 rounded-3xl border p-6 md:p-8 ${isDarkMode ? "bg-[#1e293b]/40 border-slate-800/60" : "bg-white border-slate-200"}`}
        >
          <h3
          ...
          <div className="space-y-6">
            <div>
              ...
              <div
                className={`h-3 w-full rounded-full overflow-hidden ${isDarkMode ? "bg-slate-800" : "bg-slate-100"}`}
              >
                <div
        ...
        <div
          className={`rounded-3xl border p-6 md:p-8 flex flex-col justify-center items-center text-center ${isDarkMode ? "bg-[#1e293b]/40 border-slate-800/60" : "bg-white border-slate-200"}`}
        >
          <PieChart size={48} className="text-indigo-500 mb-4 opacity-80" />
          <h3
            className={`text-3xl font-black ${isDarkMode ? "text-white" : "text-slate-900"}`}
          >
            Top Marcas
          </h3>
          <p className="text-xs font-medium text-slate-400 mt-2 mb-6">
            Demanda por fabricante (Mes actual)
          </p>

          <div className="w-full space-y-3">
            <div
              className={`flex justify-between items-center p-3 rounded-xl border ${isDarkMode ? "border-slate-700 bg-[#0b121f]/50" : "border-slate-100 bg-slate-50"}`}
            >
              <span className="text-xs font-bold text-slate-500">Toyota</span>
              <span
                className={`text-xs font-black ${isDarkMode ? "text-white" : "text-slate-800"}`}
              >
                45%
              </span>
            </div>
            <div
              className={`flex justify-between items-center p-3 rounded-xl border ${isDarkMode ? "border-slate-700 bg-[#0b121f]/50" : "border-slate-100 bg-slate-50"}`}
            >
              <span className="text-xs font-bold text-slate-500">Honda</span>
              <span
                className={`text-xs font-black ${isDarkMode ? "text-white" : "text-slate-800"}`}
              >
                30%
            ...
            <div
              className={`flex justify-between items-center p-3 rounded-xl border ${isDarkMode ? "border-slate-700 bg-[#0b121f]/50" : "border-slate-100 bg-slate-50"}`}
            >
              <span className="text-xs font-bold text-slate-500">Daihatsu</span>
              <span
                className={`text-xs font-black ${isDarkMode ? "text-white" : "text-slate-800"}`}
              >
                15%
